...
void boardProcessCanRx(size_t busIndex, const CANRxFrame& frame, efitick_t nowNt) {
	...
	if (CAN_SID(frame) == 0x133) {
		...
		efiPrintf("1: %d, 2: %d, 3: %d, 4: %d, 5: %d", static_cast<int>(frame.data8[0]), static_cast<int>(frame.data8[1]), static_cast<int>(frame.data8[2]), static_cast<int>(frame.data8[3]), static_cast<int>(frame.data8[4]));

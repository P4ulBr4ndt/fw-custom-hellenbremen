...
void boardPeriodicSlow() {
	...
	bool cfcIsShutdownRunning  = cfcRunning && !isEngineActive && (engNotRunningTimer.getElapsedSeconds() <= config->cfcMaxRuntimeAfterEngShutdown && currCltTemp > config->cfcEngShutdownOffTemp);
